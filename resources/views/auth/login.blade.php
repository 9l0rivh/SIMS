...
<body class="login login_screen_body">
<style>
    .login_screen_body {
        min-height: 100vh;
        display: flex;
    ...
    hr {
        background: linear-gradient(90deg, var(--gradient_1) 0%, #f7a817 51%, var(--gradient_1) 100%) !important;
            ...
            <div class="col-lg-6 col-md-8">
                <div class="form-wrap text-center">
                    <div class="logo-container">
                        ...
                        <h1 class="heading d-none d-lg-block">STUDENTS INFORMATION MANAGEMENT SYSTEM</h1>
                    </div>

                    <h5 class="text-uppercase">@lang('auth.login')</h5>
