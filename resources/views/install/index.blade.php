        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Students Information management system </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing SIMS for your school administration. Please follow the steps to complete SIMS installation!</p>
