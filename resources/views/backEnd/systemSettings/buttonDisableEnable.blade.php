...
@section('mainContent')
    <style type="text/css">
        ...
        input:checked + .slider {
            background: linear-gradient(90deg, var(--gradient_1) 0%, #f7a817 51%, var(--gradient_1) 100%);
        }

        input:focus + .slider {
            box-shadow: 0 0 1px linear-gradient(90deg, var(--gradient_1) 0%, #f7a817 51%, var(--gradient_1) 100%);
        }
