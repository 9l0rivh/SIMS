...
.custome-button{ 
    ...
    border: 1px solid #f7a817 !important;
    border-radius: 20px !important;
    width: 60%;
    margin: 0 auto;
    font-size: 16px !important;
    background-image: linear-gradient(to left, var(--gradient_1) 0%, #f7a817 50%, var(--gradient_1) 100%);
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        <h5>AMazing Features</h5>
                        <h2>More Features Has SIMS</h2>
                        <p>it's vast! SIMS has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
