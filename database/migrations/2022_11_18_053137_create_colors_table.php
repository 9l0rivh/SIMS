...
class CreateColorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $sql = [
            ...
            ['name'  => "gradient_1", 'default_value' => "#ec681b" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
            ['name'  => "gradient_2", 'default_value' => "#f7a817" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
            ['name'  => "gradient_3", 'default_value' => "#ec681b" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
            ...
            ['name'  => "border_color", 'default_value' => "#f7a817" , 'lawn_green' =>'#03e396', 'is_color'=>1, 'status'=>1],
