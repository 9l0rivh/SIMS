    ...
    public function up()
    {
        ...
        foreach($themes as $theme){
            if($theme->title == 'Default') { 
                ...
                $sql[] = ['theme_id'  => $theme->id, 'color_id' => 2, 'value'  => "#ec681b"];
                $sql[] = ['theme_id'  => $theme->id, 'color_id' => 3, 'value'  => "#f7a817"];
                $sql[] = ['theme_id'  => $theme->id, 'color_id' => 4, 'value'  => "#ec681b"];
                ...
                $sql[] = ['theme_id'  => $theme->id, 'color_id' => 11, 'value' => "#f7a817"];
