                            ...
                            <td>
                                <div class="logo_img">
                                    ...
                                    <div class="company_info">
                                        {{isset(generalSetting()->school_name)?generalSetting()->school_name:'Student Information Management System'}} 
                                        <h5 >   {{isset(generalSetting()->address)?generalSetting()->address:'SIMS'}} </h5>
                                    </div>
                                </div>
                            </td>
                        </thead>
